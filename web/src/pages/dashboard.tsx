...
const EVENT_LABELS: Record<string, string> = {
  ...
  uploaded_codex2api: '上传 codex2api',
  codex2api_replaced: '替换 codex2api 凭据',
  codex2api_linked: '关联远端账号',
  codex2api_unlinked: '远端账号已不存在',
  codex2api_duplicate: '远端存在重复账号',
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between">
            <CardTitle className="text-base">codex2api 监控</CardTitle>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            ...
            <Link to="/codex2api" className="inline-block pt-1 text-sm text-primary hover:underline">
              前往配置 →
            </Link>
          </CardContent>
        </Card>
