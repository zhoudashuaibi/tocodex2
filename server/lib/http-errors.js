...
export const errors = {
  ...
  codex2apiUnavailable: (message) => new AppError(502, 'CODEX2API_UNAVAILABLE', message),
  codex2apiNotConfigured: (message = '请先配置 codex2api 后端地址与管理员密钥') =>
    new AppError(422, 'CODEX2API_NOT_CONFIGURED', message),
 ...
 * 前端据此写的友好文案（如 CODEX2API_NOT_CONFIGURED）永远不可达。
